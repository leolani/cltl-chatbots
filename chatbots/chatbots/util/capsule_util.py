...
def scenario_utterance_to_capsule(
    scenario: Scenario,
    place_id: str,
    location: str,
    signal: TextSignal,
...
def scenario_utterance_to_capsule_with_perspective(
    scenario: Scenario,
    place_id: str,
    location: str,
    signal: TextSignal,
...
def scenario_utterance_and_triple_to_capsule(
    scenario: Scenario,
    place_id: str,
    location: str,
    signal: TextSignal,
...
def scenario_image_perceivedBy_triple_to_capsule(
    scenario: Scenario,
    place_id: str,
    location: str,
    signal: ImageSignal,
...
def scenario_image_triple_to_capsule(
    scenario: Scenario,
    place_id: str,
    location: str,
    signal: ImageSignal,
...
def scenario_image_triple_to_capsule_without_context(
    scenario: Scenario, signal: ImageSignal, author: str, subj: str, pred: str, obj: str
):
...
def scenario_text_mention_to_capsule(
    scenario: Scenario,
    place_id: str,
    location: str,
    signal: TextSignal,
